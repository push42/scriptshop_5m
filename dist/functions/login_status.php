...
<div class="flex items-center justify-center h-screen">
    <div class="text-center">
        ...
        if (isset($_GET['status']) && $_GET['status'] == 'success'): ?>
            <h1 class="text-3xl font-bold text-green-400 mb-4">Successfully logged in!</h1>
            <p class="text-lg">Welcome back! You can now return to the homepage.</p>
        <?php elseif (isset($_GET['status']) && $_GET['status'] == 'error'): ?>
            <h1 class="text-3xl font-bold text-red-400 mb-4">Login Failed!</h1>
            <p class="text-lg">Unfortunately, there was a problem. Please try again.</p>
        <?php else: ?>
        ...
        <a href="../login.php" class="mt-6 ml-4 inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Try Again</a>
    </div>
</div>
